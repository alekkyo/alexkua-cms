...
#files_wrapper #top a span, #top a:hover, #top a span:hover{
	color:#68a9d2;
	font-weight:bold;
	text-align:center;
	font-size:large;
...
#files_wrapper #top span {
	display:block;
}

#files_wrapper div.subtitle{
	width:80%;
	margin: 0 auto;
	color:#68a9d2;
	text-align:center;
...
#files_wrapper table.table {
	width:100%;
	border-collapse: collapse; 
}

#files_wrapper table.table td{
	padding:3px;
}

#files_wrapper table.table tr.row.two {
	background-color:#fcfdfe;
}

#files_wrapper table.table tr.row.one {
	background-color:#f8f9fa;
}

#files_wrapper table.table tr.row td.icon {
	width:25px;
	padding-top:3px;
	padding-bottom:1px;
}

#files_wrapper table.table td.del {
	width:25px;
}

#files_wrapper table.table tr.row td.size {
	width: 100px; 
	text-align: right;
}

#files_wrapper table.table tr.row td.changed {
	width: 150px;
	text-align: center;
}

#files_wrapper table.table tr.header img {
	vertical-align:bottom;
}

#files_wrapper table img{
	border:0;
}
...
#files_wrapper #thumb img {
	display:block;
}

/* Login bar (at the bottom of the page) */
#files_wrapper #login_bar {
	margin: 0 auto;
	margin-top:2px;
	max-width:680px;
}

#files_wrapper #login_bar input.submit{
	float:right;
}

/* Upload area */

#files_wrapper #upload {
	margin: 0 auto;
	margin-top:2px;
	max-width:680px;
}

#files_wrapper #upload #password_container {
	margin-right:20px;
}

#files_wrapper #upload #newdir_container, #upload #password_container {
	float:left;
}

#files_wrapper #upload #upload_container{
	float:right;
}

#files_wrapper #upload input.upload_dirname, #upload input.upload_password{
	width:140px;
}

#files_wrapper #upload input.upload_file{
	font-size:small;
}

/* Breadcrumbs */

#files_wrapper div.breadcrumbs {
	display:block;
	padding:1px 3px;
	color:#cccccc;
	font-size:x-small;
...
#files_wrapper div.breadcrumbs a{
...
#files_wrapper #login div {
	display:block;
	width:100%;
	margin-top:5px;
}

#files_wrapper #login label{
	width: 120px;
	text-align: right;
}
...
#files_wrapper body.mobile #frame, body.mobile #info, body.mobile #upload {
	max-width:none;
}

#files_wrapper body.mobile {
	font-size:medium;
}

#files_wrapper body.mobile a.item {
	display:block;
	padding:10px 0;
}

#files_wrapper body.mobile a.item span.size {
	float:right;
	margin-left:10px;
}

#files_wrapper body.mobile table.table {
	margin-bottom:30px;
}

#files_wrapper body.mobile table.table tr td {
	border-top: 1px solid #CDD2D6;
}

#files_wrapper body.mobile table.table tr.last td {
	border-bottom: 1px solid #CDD2D6;
}

#files_wrapper body.mobile #top {
	padding-bottom:3px;
}

#files_wrapper body.mobile #top a {
	padding-top:3px;
}

#files_wrapper body.mobile #upload #password_container, body.mobile #upload #upload_container, body.mobile #upload #newdir_container {
	float:none;
	margin-top:5px;
}

#files_wrapper body.mobile #upload input.upload_dirname, body.mobile #upload input.upload_password{
	width:240px;
}

#files_wrapper body.mobile #upload {
	margin-bottom:15px;
}
